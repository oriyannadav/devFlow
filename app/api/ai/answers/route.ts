        ...
        const { text } = await generateText({
            ...
            prompt: `Generate a markdown-formatted response to the following question: "${question}".
                    ...
                    **Context:** ${content}
                    ...
                    Also, prioritise and incorporate the user's answer when formulating your response:
                    **User's Answer:** ${userAnswer}

                    Prioritise the user's answer only if it's correct. If it's incomplete or incorrect, improve or correct it while keeping the response concise and to the point.
