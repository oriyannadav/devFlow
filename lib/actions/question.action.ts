...
import { DeleteQuestionParams, EditQuestionParams, GetQuestionParams, IncrementViewsParams, RecommendationParams } from "@/types/action";
...
export async function deleteQuestion(params: DeleteQuestionParams): Promise<ActionResponse> {
    ...
    try {
        ...
        if (question.author.toString() !== user?.id)
            throw new Error("You are not authorised to delete this question");
