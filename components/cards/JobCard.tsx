...
const JobLocation = ({ job_country, job_state, job_city }: JobLocationProps) => {
    return (
        <div className="flex items-center justify-end gap-2 rounded-2xl px-3 py-1.5 background-light700_dark400">
            <Image 
...
const JobCard = ({ job }: { job: Job }) => {
    const { employer_logo, employer_website, job_employment_type, job_title, job_description, job_apply_link, job_city, job_state, job_country } = job;
    ...
    return (
        <section className="background-light900_dark200 light-border shadow-light100_darknone flex flex-col items-start gap-6 rounded-lg border p-6 sm:flex-row sm:p-8">
            ...
            <div className="w-full">
                <div className="flex-between flex-wrap ga-2">
